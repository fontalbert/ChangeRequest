...
/******/ 	deferredModules.push(["./Content/js/changerequest/index.jsx","vendor"]);
...
/***/ "./Content/js/changerequest/component/change-request-form.jsx":
/*!********************************************************************!*\
  !*** ./Content/js/changerequest/component/change-request-form.jsx ***!
  \********************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _myToastr = __webpack_require__(/*! ../../common/toastr/myToastr.jsx */ \"./Content/js/common/toastr/myToastr.jsx\");\n\nvar _myToastr2 = _interopRequireDefault(_myToastr);\n\nvar _appContext = __webpack_require__(/*! ../../app/context/app-context.jsx */ \"./Content/js/app/context/app-context.jsx\");\n\nvar _appContext2 = _interopRequireDefault(_appContext);\n\nvar _changeRequest = __webpack_require__(/*! ../model/change-request.jsx */ \"./Content/js/changerequest/model/change-request.jsx\");\n\nvar _changeRequest2 = _interopRequireDefault(_changeRequest);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\n//Modules\n\n//Models\n\n\nvar ChangeRequestForm = function (_React$Component) {\n    _inherits(ChangeRequestForm, _React$Component);\n\n    function ChangeRequestForm(props) {\n        _classCallCheck(this, ChangeRequestForm);\n\n        //this.changeRequest = new ChangeRequest();\n        var _this = _possibleConstructorReturn(this, (ChangeRequestForm.__proto__ || Object.getPrototypeOf(ChangeRequestForm)).call(this, props));\n\n        _this.status = [{ text: 'Select an option', value: '' }, { text: 'Open', value: 'Open' }, { text: 'In Progress', value: 'In Progress' }, { text: 'Closed', value: 'Closed' }];\n\n        _this.priority = [{ text: 'Select an option', value: '' }, { text: '1-High', value: '1-High' }, { text: '2-Medium', value: '2-Medium' }, { text: '3-Low', value: '3-Low' }];\n\n        _this.state = {\n            loading: false,\n            changeRequest: null\n        };\n\n        // 'this' bindings\n        return _this;\n    }\n\n    //if the component is rendered for the first time\n\n\n    _createClass(ChangeRequestForm, [{\n        key: 'componentDidMount',\n        value: function componentDidMount() {\n            this.load(true);\n        }\n    }, {\n        key: 'load',\n        value: function load(componentDidMount) {\n            if (componentDidMount) {\n                this.setState({\n                    changeRequest: new _changeRequest2.default()\n                });\n            }\n        }\n    }, {\n        key: 'render',\n        value: function render() {\n            console.log(this.context);\n            return _react2.default.createElement(\n                _react2.default.Fragment,\n                null,\n                _react2.default.createElement(_myToastr2.default, null),\n                this.state.changeRequest ? _react2.default.createElement(\n                    'form',\n                    { id: 'editForm', className: 'row' },\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'col-md-6' },\n                        'Column 1'\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'col-md-6' },\n                        'Column 2'\n                    ),\n                    _react2.default.createElement(\n                        'div',\n                        { className: 'col-md-12' },\n                        _react2.default.createElement(\n                            'a',\n                            { href: this.context.mainUrl, className: 'btn btn-default' },\n                            this.context.resources.btnBack\n                        )\n                    ),\n                    JSON.stringify(this.state.changeRequest)\n                ) : ''\n            );\n        }\n    }]);\n\n    return ChangeRequestForm;\n}(_react2.default.Component);\n\nexports.default = ChangeRequestForm;\n\n\nChangeRequestForm.contextType = _appContext2.default;\n\n//# sourceURL=webpack:///./Content/js/changerequest/component/change-request-form.jsx?");

/***/ }),

/***/ "./Content/js/changerequest/index.jsx":
/*!********************************************!*\
  !*** ./Content/js/changerequest/index.jsx ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar ChangeRequest = function () {\n    function ChangeRequest() {\n        _classCallCheck(this, ChangeRequest);\n\n        this.Id = 0;\n        this.Title = '';\n        this.Description = '';\n        this.Justification = '';\n        this.Impact = '';\n        this.RequestDate = '';\n        this.RequestBy = '';\n        this.Status = '';\n        this.Priority = '';\n    }\n\n    _createClass(ChangeRequest, null, [{\n        key: 'Create',\n        value: function Create(data) {\n            var o = new ChangeRequest();\n            Object.assign(o, data);\n            return o;\n        }\n    }]);\n\n    return ChangeRequest;\n}();\n\nexports.default = ChangeRequest;\n\n//# sourceURL=webpack:///./Content/js/changerequest/model/change-request.jsx?");
